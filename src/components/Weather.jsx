  ...
  useEffect(() => {
    ...
    function mapSuccess(position) {
      ...
      axios
        ...
        .get("https://maps.googleapis.com/maps/api/geocode/json?latlng=" + lat + "," + lon + "&key=AIzaSyBCBHsvwjZ8DUQHaA1edwyzBCY83aDrge0")
        .then((response) => {
      ...
      axios
        ...
        .get("http://api.openweathermap.org/data/2.5/weather?lat=" + lat + "&lon=" + lon + "&APPID=0c903771d77ae06f65e9bef84f34a1cc")
        .then((response) => {
